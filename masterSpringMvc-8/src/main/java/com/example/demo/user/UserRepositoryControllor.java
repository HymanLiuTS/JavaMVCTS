...
public class UserRepositoryControllor {
	...
	//@Secured("ROLE_ADMIN")
	public ResponseEntity<Collection<Tweet>> query() {
		ResponseEntity<Collection<Tweet>> result = new ResponseEntity<Collection<Tweet>>(userRepository.query(), HttpStatus.BAD_REQUEST);
		return result;
	}
